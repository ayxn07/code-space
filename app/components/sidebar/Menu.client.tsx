...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-bolt-elements-textSecondary border-b border-bolt-elements-sidebar-border">
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-bolt-elements-sidebar-background border-r border-bolt-elements-borderColor',
          'shadow-sm text-sm',
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ...
                    : 'bg-bolt-elements-bg-depth-3 text-bolt-elements-textSecondary hover:bg-bolt-elements-bg-depth-2 border border-bolt-elements-borderColor',
                )}
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-bolt-elements-bg-depth-2 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-accent-500/50 text-sm text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary border border-bolt-elements-borderColor"
                type="search"
