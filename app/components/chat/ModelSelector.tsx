...
const highlightText = (text: string, query: string): string => {
  ...
  return text.replace(regex, '<mark class="bg-accent-200 dark:bg-accent-800 text-current">$1</mark>');
};
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={classNames(
                      ...
                      'hover:bg-bolt-elements-background-depth-3',
                      showFreeModelsOnly
                        ? 'bg-[var(--theme-accent-500-20,#9C7DFF33)] text-accent-500 border border-[var(--theme-accent-500-30,#9C7DFF4D)]'
