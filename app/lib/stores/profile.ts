...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('hack_cortex_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('hack_cortex_profile', JSON.stringify(profileStore.get()));
  }
};
